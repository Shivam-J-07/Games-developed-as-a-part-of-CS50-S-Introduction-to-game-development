            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local initalPlayerHP = self.playerPokemon.HP
                        local initalPlayerAttack = self.playerPokemon.attack
                        local initalPlayerDefense = self.playerPokemon.defense
                        local initalPlayerSpeed = self.playerPokemon.speed

                        local HPIncrease, attackIncrease, defenseIncrease, speedIncrease = self.playerPokemon:levelUp()

                        local statImprovements = {
                            {text = 'HP:' .. initalPlayerHP .. '+'.. HPIncrease .. '=' .. initalPlayerHP + HPIncrease},
                            {text = 'Attack:' .. initalPlayerAttack .. '+'.. attackIncrease .. '=' .. initalPlayerAttack + attackIncrease},
                            {text = 'Defense:' .. initalPlayerDefense .. '+'.. defenseIncrease .. '=' .. initalPlayerDefense + defenseIncrease},
                            {text = 'Speed:' .. initalPlayerSpeed .. '+'.. speedIncrease .. '=' .. initalPlayerSpeed + speedIncrease}
                        }

                        gStateStack:push(BattleMessageState('Congratulations! Level Up!',
                        function()
                          gStateStack:push(IncreaseStatsState({
