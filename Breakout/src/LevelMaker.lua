...
function LevelMaker.createMap(level)
    ...
    local lockedBrickPresent = math.random(1, 2) == 1 and true or false
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            if y == lockedBrickRow and x == lockedBrickCol and lockedBrickPresent == true then
              b.color = 5
              b.tier = 3
              b.locked = 2
              b.isLocked = true
