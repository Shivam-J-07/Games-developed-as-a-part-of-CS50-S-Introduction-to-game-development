...
require 'src/states/entity/player/PlayerWalkPotIdleState'
...
gSounds = {
    ...
    ['lift-pot'] = love.audio.newSource('sounds/lift_pot.wav'),
    ['pot-break'] = love.audio.newSource('sounds/pot_break.wav')
}
